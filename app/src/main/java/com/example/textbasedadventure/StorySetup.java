...
public class StorySetup {
    ...
    private void addRogueOptions() {
        ...
        StoryOption exploreTheGrounds = new StoryOption("explore the grounds","You manage to slip away as the Duke is lost between grief and drink. You manage to find an alcove in one hall of the castle. Your clandestine expertise allows you to spot that it is in fact a false door. A long spiral staircase descends deep into the earth. You plunge into the depths. After descending for what feels like a lifetime you come to a dank chamber. As your eyes adjust to the light you find a young maiden chained to the wall. She cries out for help as figure looms behind you. The Duke");
        StoryOption fightDuke = new StoryOption("Defend yourself","You dodge swiftly out of the way just before a large claw decapitates you. The Duke lets out a howling rage as patches of thick silvery fur begin to sprout from his skin. You fool, you couldn't just lay down and die could you? he utters before fully transforming. The Duke was always perceived as a bit crass but few would expect him to be a lycanthrope. You are more than prepared however, you parry his next swipe expertly and plunge your silvered dagger deep into the beasts chest. With one fell blow it lay slain upon the cobbles.");
